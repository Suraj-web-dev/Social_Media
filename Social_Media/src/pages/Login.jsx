  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-40">
        <img src="/logo.svg" alt="" className="h-12 object-contain" />
        <div>
          <div className="flex items-center gap-3 mb max-md:mt-10">
            <img src="/group_users.png" className="h-8 md:h-10" alt="" />
            <div>
              <div className="">
                {Array(5)
                  .fill(0)
